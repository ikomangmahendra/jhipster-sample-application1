...
import { GudangComponent } from 'app/entities/gudang/gudang.component';
import { GudangService } from 'app/entities/gudang/gudang.service';
import { Gudang } from 'app/shared/model/gudang.model';

describe('Component Tests', () => {
  describe('Gudang Management Component', () => {
    let comp: GudangComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GudangComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.gudangs && comp.gudangs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
