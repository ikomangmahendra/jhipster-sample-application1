...
import { CatalogItemComponent } from 'app/entities/catalog-item/catalog-item.component';
...
describe('Component Tests', () => {
  describe('CatalogItem Management Component', () => {
    let comp: CatalogItemComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CatalogItemComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.catalogItems && comp.catalogItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
