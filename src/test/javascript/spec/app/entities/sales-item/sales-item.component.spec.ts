...
import { SalesItemComponent } from 'app/entities/sales-item/sales-item.component';
...
describe('Component Tests', () => {
  describe('SalesItem Management Component', () => {
    let comp: SalesItemComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SalesItemComponent, '')
        .compileComponents();
