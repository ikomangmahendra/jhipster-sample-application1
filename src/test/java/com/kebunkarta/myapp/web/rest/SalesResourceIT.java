...
public class SalesResourceIT {
    ...
    public void createSales() throws Exception {
        ...
        assertThat(testSales.isDiscPercentStatus()).isEqualTo(DEFAULT_DISC_PERCENT_STATUS);
    ...
    public void updateSales() throws Exception {
        ...
        assertThat(testSales.isDiscPercentStatus()).isEqualTo(UPDATED_DISC_PERCENT_STATUS);
