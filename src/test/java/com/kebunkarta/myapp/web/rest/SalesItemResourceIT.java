...
public class SalesItemResourceIT {
    ...
    public void createSalesItem() throws Exception {
        ...
        assertThat(testSalesItem.isIsDiscPercent()).isEqualTo(DEFAULT_IS_DISC_PERCENT);
        assertThat(testSalesItem.getTax()).isEqualTo(DEFAULT_TAX);
    ...
    public void updateSalesItem() throws Exception {
        ...
        assertThat(testSalesItem.isIsDiscPercent()).isEqualTo(UPDATED_IS_DISC_PERCENT);
        assertThat(testSalesItem.getTax()).isEqualTo(UPDATED_TAX);
