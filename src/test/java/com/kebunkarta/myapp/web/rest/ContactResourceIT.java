...
public class ContactResourceIT {
    ...
    private static final Boolean DEFAULT_CUSTOMER_STATUS = false;
    private static final Boolean UPDATED_CUSTOMER_STATUS = true;

    private static final Boolean DEFAULT_SUPPLIER_STATUS = false;
    private static final Boolean UPDATED_SUPPLIER_STATUS = true;
    ...
    public void createContact() throws Exception {
        ...
        assertThat(testContact.isCustomerStatus()).isEqualTo(DEFAULT_CUSTOMER_STATUS);
        assertThat(testContact.isSupplierStatus()).isEqualTo(DEFAULT_SUPPLIER_STATUS);
    ...
    public void getAllContacts() throws Exception {
        ...
        restContactMockMvc.perform(get("/api/contacts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].customerStatus").value(hasItem(DEFAULT_CUSTOMER_STATUS.booleanValue())))
            .andExpect(jsonPath("$.[*].supplierStatus").value(hasItem(DEFAULT_SUPPLIER_STATUS.booleanValue())))
    ...
    public void getContact() throws Exception {
        ...
        restContactMockMvc.perform(get("/api/contacts/{id}", contact.getId()))
            ...
            .andExpect(jsonPath("$.customerStatus").value(DEFAULT_CUSTOMER_STATUS.booleanValue()))
            .andExpect(jsonPath("$.supplierStatus").value(DEFAULT_SUPPLIER_STATUS.booleanValue()))
    ...
    public void updateContact() throws Exception {
        ...
        Contact testContact = contactList.get(contactList.size() - 1);
        assertThat(testContact.isCustomerStatus()).isEqualTo(UPDATED_CUSTOMER_STATUS);
        assertThat(testContact.isSupplierStatus()).isEqualTo(UPDATED_SUPPLIER_STATUS);
