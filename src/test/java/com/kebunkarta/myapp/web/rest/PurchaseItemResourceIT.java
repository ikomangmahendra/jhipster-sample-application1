...
public class PurchaseItemResourceIT {
    ...
    public void createPurchaseItem() throws Exception {
        ...
        assertThat(testPurchaseItem.isIsDiscPercent()).isEqualTo(DEFAULT_IS_DISC_PERCENT);
        assertThat(testPurchaseItem.getTax()).isEqualTo(DEFAULT_TAX);
    ...
    public void updatePurchaseItem() throws Exception {
        ...
        assertThat(testPurchaseItem.isIsDiscPercent()).isEqualTo(UPDATED_IS_DISC_PERCENT);
        assertThat(testPurchaseItem.getTax()).isEqualTo(UPDATED_TAX);
