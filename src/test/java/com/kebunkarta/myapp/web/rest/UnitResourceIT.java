...
public class UnitResourceIT {
    ...
    private static final Boolean DEFAULT_BASE_UNIT_STATUS = false;
    private static final Boolean UPDATED_BASE_UNIT_STATUS = true;
    ...
    public static Unit createEntity(EntityManager em) {
        Unit unit = new Unit()
            ...
            .baseUnitStatus(DEFAULT_BASE_UNIT_STATUS)
    ...
    public static Unit createUpdatedEntity(EntityManager em) {
        Unit unit = new Unit()
            ...
            .baseUnitStatus(UPDATED_BASE_UNIT_STATUS)
    ...
    public void createUnit() throws Exception {
        ...
        assertThat(testUnit.isBaseUnitStatus()).isEqualTo(DEFAULT_BASE_UNIT_STATUS);
    ...
    @Test
    @Transactional
    public void checkBaseUnitStatusIsRequired() throws Exception {
        int databaseSizeBeforeTest = unitRepository.findAll().size();
        // set the field null
        unit.setBaseUnitStatus(null);
    ...
    public void getAllUnits() throws Exception {
        ...
        restUnitMockMvc.perform(get("/api/units?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].baseUnitStatus").value(hasItem(DEFAULT_BASE_UNIT_STATUS.booleanValue())))
    ...
    public void getUnit() throws Exception {
        ...
        restUnitMockMvc.perform(get("/api/units/{id}", unit.getId()))
            ...
            .andExpect(jsonPath("$.baseUnitStatus").value(DEFAULT_BASE_UNIT_STATUS.booleanValue()))
    ...
    public void updateUnit() throws Exception {
        ...
        assertThat(testUnit.isBaseUnitStatus()).isEqualTo(UPDATED_BASE_UNIT_STATUS);
