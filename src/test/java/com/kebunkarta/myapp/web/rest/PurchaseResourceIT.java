...
public class PurchaseResourceIT {
    ...
    public void createPurchase() throws Exception {
        ...
        assertThat(testPurchase.isDiscPercentStatus()).isEqualTo(DEFAULT_DISC_PERCENT_STATUS);
    ...
    public void updatePurchase() throws Exception {
        ...
        assertThat(testPurchase.isDiscPercentStatus()).isEqualTo(UPDATED_DISC_PERCENT_STATUS);
