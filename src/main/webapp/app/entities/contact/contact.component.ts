...
export class ContactComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.contactService
      ...
      .subscribe(
        (res: HttpResponse<IContact[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IContact[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
