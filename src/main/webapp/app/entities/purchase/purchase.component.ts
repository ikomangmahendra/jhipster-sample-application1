...
export class PurchaseComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.purchaseService
      ...
      .subscribe(
        (res: HttpResponse<IPurchase[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPurchases(): void {
    this.eventSubscriber = this.eventManager.subscribe('purchaseListModification', () => this.loadPage());
  }
