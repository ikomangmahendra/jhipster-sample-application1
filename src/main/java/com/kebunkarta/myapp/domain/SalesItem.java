...
public class SalesItem implements Serializable {
    ...
    public SalesItem discPercentStatus(Boolean discPercentStatus) {
    ...
    public SalesItem taxAmount(BigDecimal taxAmount) {
    ...
    public SalesItem catalog(CatalogItem catalogItem) {
