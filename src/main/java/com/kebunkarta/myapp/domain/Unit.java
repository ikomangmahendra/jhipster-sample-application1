...
public class Unit implements Serializable {
    ...
    @NotNull
    @Column(name = "base_unit_status", nullable = false)
    private Boolean baseUnitStatus;
    ...
    public Boolean isBaseUnitStatus() {
        return baseUnitStatus;
    }

    public Unit baseUnitStatus(Boolean baseUnitStatus) {
        this.baseUnitStatus = baseUnitStatus;
        return this;
    }

    public void setBaseUnitStatus(Boolean baseUnitStatus) {
        this.baseUnitStatus = baseUnitStatus;
    }
    ...
    public Unit recordStatusId(Integer recordStatusId) {
    ...
    public String toString() {
        return "Unit{" +
            ...
            ", baseUnitStatus='" + isBaseUnitStatus() + "'" +
