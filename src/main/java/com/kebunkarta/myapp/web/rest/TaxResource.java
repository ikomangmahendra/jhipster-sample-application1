...
/**
 * REST controller for managing {@link com.kebunkarta.myapp.domain.Tax}.
 */
@RestController
@RequestMapping("/api")
public class TaxResource {
    ...
    public ResponseEntity<TaxDTO> updateTax(@Valid @RequestBody TaxDTO taxDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, taxDTO.getId().toString()))
            .body(result);
    }
